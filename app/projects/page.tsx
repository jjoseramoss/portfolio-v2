...
import pokeIcon from "../../public/poke-icon.png";
    ...
    <div className="w-screen min-h-screen overflow-y-auto flex justify-center md:items-center text-sm">
      <div className="w-[95%] md:w-[35%] p-5 my-10 flex flex-col">
        ...
        <div className="pt-6 font-light text-gray-800 tracking-wider mt-5 flex flex-col gap-y-5">
          <ProjectCard
            name="POGO Scout"
            description="Track live and upcoming Pokémon GO events, filter by category, and add calendar reminders."
            link="https://pogo-events.onrender.com/"
            tools={["react", "typescript", "express", "tailwindcss"]}
            icon={pokeIcon}
            alt="Pokeball"
          />
          <ProjectCard
